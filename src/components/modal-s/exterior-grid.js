...
const ExteriorGrid = () => {
  return (
    <section className="w-full bg-black pt-40 pb-20 md:py-24 md:px-4 xl:px-32">
      <div className="container mx-auto">
        <div className="text-white md:flex md:items-center mb-1 ">
          <div className="md:w-1/2">
            <img
              className=""
              src="/images/model-s/Model-S-Exterior-Grid-A-Desktop-Global.jpg"
        ...
        <div className="text-white md:flex md:flex-row-reverse md:items-center mb-1 ">
          <div className="md:w-1/2">
            <img
              className=""
              src="/images/model-s/Model-S-Exterior-Grid-B-Desktop-Global.jpg"
              alt="model-s-interior"
            />
          </div>
          <div className="p-2 m-2 pb-10 md:pb-4 md:w-1/2 md:px-8 xl:px-16 ">
        ...
        <div className="text-white md:flex md:items-center mb-1 ">
          <div className="md:w-1/2">
            <img
              className=""
              src="/images/model-s/Model-S-Exterior-Grid-C-Desktop-Global.jpg"
              alt="model-s-interior"
            />
          </div>
          <div className="p-2 m-2 pb-10 md:pb-4 md:w-1/2 md:px-8 xl:px-16 ">
