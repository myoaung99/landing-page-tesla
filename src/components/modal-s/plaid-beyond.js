...
const BeyondLudicrous = () => {
  return (
    <section className="w-full h-screen">
      ...
      <div className="p-3 m-3 md:m-6 lg:mb-0 lg:pb-0 lg:max-w-3xl lg:mx-auto lg:flex lg:items-end">
        <div className="">
          <h3 className="font-light text-lg">Plaid</h3>
          <h2 className="text-3xl mb-5 whitespace-nowrap">Beyond Ludicrous</h2>
        </div>

        <p className="text-gray-700 lg:px-12 lg:text-sm ">
      ...
      <div className="px-3 m-3 md:mx-6 lg:max-w-3xl lg:mx-auto">
        <button className="w-full md:w-48 lg:w-2/6 border-2 border-black rounded-3xl py-2  tracking-widest text-sm uppercase whitespace-nowrap">
          order now
        </button>
      </div>
    </section>
